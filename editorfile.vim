...
"Vim-smooth-scroll
noremap <silent> <c-u> :call smooth_scroll#up(&scroll, 30, 4)<CR>M
noremap <silent> <c-d> :call smooth_scroll#down(&scroll, 30, 4)<CR>M
noremap <silent> <c-b> :call smooth_scroll#up(&scroll*2, 30, 6)<CR>M
noremap <silent> <c-f> :call smooth_scroll#down(&scroll*2, 30, 6)<CR>M
nmap <Leader>a <C-B>
nmap <Leader>z <C-F>
nmap <Leader>s <C-U>
nmap <Leader>x <C-D>
